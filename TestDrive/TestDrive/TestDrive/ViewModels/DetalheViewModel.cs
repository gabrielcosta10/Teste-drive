...
namespace TestDrive.ViewModels
{
    public class DetalheViewModel:BaseViewModel
    {
        ...
        public string TextoArCondicionado { get { return string.Format("ArCondicionado - R${0}", Veiculo.AR_CONDICIONADO); } }
        public string TextoMP3Player { get { return string.Format("MP3 Player - R${0}", Veiculo.MP3__PLAYER); } }
        ...
        public bool TemArCondicionado
        {
            ...
            set { Veiculo.TemArCondicionado = value; OnPropertyChanged();
        ...
        public string ValorTotal { get { return Veiculo.PrecoTotalFormatado; } }
